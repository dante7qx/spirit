...
public class ResourceController {
	...
	public BaseResp<ResourceRespDTO> updateResource(@RequestBody ResourceReqDTO resourceVO) {
	...
	public BaseResp<?> updateResourceWhenDrap(@RequestBody EasyUIDragTreeReq dragTreeReq) {
