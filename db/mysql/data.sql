...
(19, 'public', '定时任务管理', '定时任务管理', 2, 5, 1, now()),
(20, 'sysmgr.scheduler.query', '查询定时任务', '查询定时任务', 19, 1, 1, now()),
(21, 'sysmgr.scheduler.update', '更新定时任务', '更新定时任务', 19, 2, 1, now()),
(22, 'sysmgr.scheduler.delete', '删除定时任务', '删除定时任务', 19, 3, 1, now()),

(23, 'sysmgr.syslog.query', '系统日志管理', '系统日志管理', 2, 5, 1, now())
;
